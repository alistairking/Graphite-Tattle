...
?>
  <div class="row">
    <div class="span6">
      <form action="?action=<?php echo $action.$query_string; ?>" method="post">
        <div class="main" id="main">
          <fieldset>
                <div class="clearfix">
	      <label for="line-friendly_name">Name<em>*</em></label>
              <div class="input">
	        <?php echo $setting->encodeFriendlyName(); ?>
              </div>
            </div><!-- /clearfix -->
            <div class="clearfix">
              <label for="line-value">Value<em>*</em></label>
              <div class="input">             
	        <input id="line-value" class="span3" type="text" size="30" name="value" value="<?php echo $setting->encodeValue(); ?>" />
              </div>
            </div><!-- /clearfix -->
        <div class="actions">
